    ...
    if '/creator_bio' in creator_bio_info_url:
        if 'First' in creator_has_built_projects_number:
            ...
            try:
                ...
                creator_info_status_list = sel.xpath(
                    '//*[@class="creator-bio-details col col-4 pt2 pb6"]//*[@class="created-projects py1 h5 mb2"]//*/@href')
            ...
            try:
                ...
                possible_urls = sel.xpath(
                    '//*[@class="project-card-list NS_user__projects_list list ratio-16-9"]/li[*]//*[@class="project-thumbnail-wrap"]/@href')
